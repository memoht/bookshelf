...
RSpec.feature "Books index pagination" do
  ...
  it "returns the correct page of books" do
    ...
    expect(page.find("h5:nth-child(1)")).to have_content "Book 0, by Author 0"
    expect(page.find("h5:nth-child(2)")).to have_content "Book 1, by Author 1"
    expect(page.find("h5:nth-child(3)")).to have_content "Book 2, by Author 2"
  end
end
